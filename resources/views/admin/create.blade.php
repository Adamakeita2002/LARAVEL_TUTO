                    ...
                    <div class="row g-4 settings-section">
                        <div class="col-12 col-md-4">
                            ...
                            <div class="section-intro">
                                Ajouter un nouveau administrateurs dans la base de donnee
                                    ...
                                    <form class="settings-form" action="{{ route('admin.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                ...
                                                placeholder="Entrez le nom Complet de l'administrateur" />
                                            @error('name')
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                ...
                                                placeholder="Entrez l'email valide de l'administrateur" />
                                            @error('email')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
