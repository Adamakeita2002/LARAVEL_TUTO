        ...
        <div class="app-wrapper">
            <div class="app-content pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <h1 class="app-page-title">GESTION DE COMPTES</h1>
                    <hr class="mb-4" />
                    <div class="row g-4 settings-section">
                        <div class="col-12 col-md-4">
                            <h3 class="section-title">Modifier vos informations</h3>
                            <div class="section-intro">
                                Ici vous pouvez modifier les informations de compte votre compte.
                            </div>
                        </div>
                        <div class="col-12 col-md-8">
                            <div class="app-card app-card-settings shadow-sm p-4">
                                <div class="app-card-body">
                                    <form class="settings-form" action="{{ route('admin.update', Auth::user()->id) }}"
                                        ...
                                        @endif
                                        <div class="mb-3">
                                            <label for="setting-input-1" class="form-label">Ajouter une photo de
                                                profile<span class="ms-2" data-container="body" data-bs-toggle="popover"
                                            ...
                                            <input type="file" class="form-control" id="setting-input-1" value=""
                                                name="image" />
                                            @error('image')
                                            ...
                                            <div class="mb-3">
                                                <label for="setting-input-1" class="form-label">Ancien mot de
                                                    passe<span class="ms-2" data-container="body"
                                            ...
                                            <div class="mb-3">
                                                <label for="setting-input-1" class="form-label">Nouveau mot de
                                                    passe<span class="ms-2" data-container="body"
                                                        data-bs-toggle="popover" data-trigger="hover"
                                                        data-placement="top"
                                                        data-content="This is a Bootstrap popover example. You can use popover to provide extra info."><svg
